...
class Uploader
{
     ...
     */
    public function __construct( $fileField , $config ,$request, $base64 = false )
    {
    ...
    private function upFile( $base64 )
    {
        ...
        if ( "base64" == $base64 ) {
            ...
            $content = $this->request->post[ $this->fileField ];
        ...
        $file = $this->file = $this->request->files[ $this->fileField ];
        if ( !$file ) {
